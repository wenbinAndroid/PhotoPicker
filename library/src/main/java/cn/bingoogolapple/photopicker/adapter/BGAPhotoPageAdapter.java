...
public class BGAPhotoPageAdapter extends PagerAdapter {
    ...
    private PhotoPreListener mListener;
    private ArrayList<String> mData;

    public BGAPhotoPageAdapter(PhotoViewAttacher.OnViewTapListener onViewTapListener, PhotoPreListener listener) {
        mOnViewTapListener = onViewTapListener;
        this.mListener = listener;

    }

    public BGAPhotoPageAdapter(PhotoViewAttacher.OnViewTapListener onViewTapListener, ArrayList<String> data) {
        mOnViewTapListener = onViewTapListener;
        this.mData = data;
    }
    ...
    public View instantiateItem(ViewGroup container, int position) {
        ...
        BGAImage.display(imageView, R.mipmap.bga_pp_ic_holder_dark, mListener == null ? mData.get(position) : mListener.getPhotoPath(position), BGAPhotoPickerUtil.getScreenWidth(), BGAPhotoPickerUtil.getScreenHeight());
    ...
    public String getItem(int position) {
        ...
        return mListener.getPhotoPath(position);
    }
}